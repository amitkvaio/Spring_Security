...
public class BasicAuthenticationController {
	...
	public String basicAuthentication(Authentication authentication) {
		String userName = authentication.getName();
		return "Hey! "+ userName + " Do you know that!? Basic Authentication is a simple way to secure your web application.\r\n"
